...
`cast`/`wrap` on a type parameter and **overloading** are all **done** (2026-09-18), leaving
type-argument inference. The
...
thing that makes the two sets overlap.
