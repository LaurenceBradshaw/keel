...
and `cast`/`wrap` on a type parameter are **both done** (2026-09-18), leaving overloading
and type-argument inference. The
...
operators arrive at M7*, after which a type that orders itself satisfies it and still does
