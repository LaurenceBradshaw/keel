...
delete — see §15. **What is left in M6.5 is the conditional-expression decision**, which is a
decision rather than an implementation. Function pointers implement at M6.5 or M8.
